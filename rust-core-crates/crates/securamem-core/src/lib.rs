...
// BRANDED TERMINOLOGY
// =============================================================================
// These type aliases provide marketing-consistent naming for the dashboard API
// while preserving internal implementation names.

/// The NeuroWall™ - Semantic inference guard
/// 
/// Marketing name for the semantic firewall that blocks jailbreak attempts
/// before they reach the LLM. Uses 384D embeddings for threat detection.
/// 
/// Internal implementation: `SemanticEngine` in `securamem-firewall`
pub const NEUROWALL_BRAND: &str = "NeuroWall";

/// The AI Flight Recorder™ - Cryptographic audit orchestrator
/// 
/// Marketing name for the immutable audit chain that provides court-admissible
/// evidence of all AI decisions. Uses Ed25519 + SHA-256 hash chaining.
/// 
/// Internal implementation: `AuditOrchestrator` in `securamem-l1`
pub const FLIGHT_RECORDER_BRAND: &str = "AI Flight Recorder";

/// Sovereign Mode™ - Air-gapped local operation
/// 
/// Marketing name for the air-gapped deployment model that ensures
/// zero external dependencies and no cloud connectivity.
/// 
/// Internal implementation: `LocalhostAddr` enforcement
pub const SOVEREIGN_MODE_BRAND: &str = "Sovereign Mode";

/// Product version for branding
pub const SECURAMEM_VERSION: &str = "2.0.0";

/// Product tagline
pub const SECURAMEM_TAGLINE: &str = "The AI Black Box Recorder";
